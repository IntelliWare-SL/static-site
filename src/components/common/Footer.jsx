...
const Footer = () => {
    return (
        <footer className="p-0 m-0 pt-md-4">
            <Container className="mt-0 mb-0 mb-md-4 pt-4 pb-0 pb-md-4">
                <Row
                    xs={12}
                    className="justify-content-between pb-2 px-5 px-md-0 pt-md-2 pb-md-4"
                >
                    <Col
                        xs={12}
                        md={4}
                        className="footer-section section-border p-4 p-lg-0"
                    >
                        <div className="brand-section-wrapper p-2">
                            <div className="brand-logo pt-2 pb-3">
                                <img
                                    src={brandLogoLong}
                                    alt="Reamer Made logo"
                                    width="100%"
                                />
                            </div>
                            <div className="brand-tagline py-2">
                                <p>
                                    We are dedicated to helping you tell your
                                    story and branding yourself in the industry.{' '}
                                </p>
                            </div>
                            <div className="m-auto me-md-auto w-100">
                                <SocialMediaIcons
                                    customClasses={
                                        'justify-content-start strict-align-left'
                                    }
                                />
                            </div>
                        </div>
                        ...
                        <div className="brand-section-wrapper p-2">
                            <div className="section-2-title text-white py-2">
                                <h5>
                                    ...
                                    <br />
                                    <span>Use our online form.</span>
                                </h5>
                            </div>
                            <div className="section-2-text pt-2 pb-3 pb-lg-2">
                                <p className="pb-md-2">
                            ...
                            <CustomAnimatedButton
                                ...
                                text={'Send Inquiry'}
                                customClasses={
                                    'mt-0 mb-3 d-block d-sm-inline-block'
                                }
                            />
                        </div>
                    </Col>
                    <Col
                        xs={12}
                        md={4}
                        className="footer-section p-4 pb-3 p-lg-0"
                    >
                        <div className="brand-section-wrapper p-2 px-0 px-sm-2">
                            <div className="brand-logo pt-2 pb-1 pb-md-3">
                                <h3>Contact Us</h3>
                            </div>
                            <div className="pt-4 pt-md-0 p-2 p-md-0">
                                <ContactDetailsField
                                    icon={
                                        <svg
                                            width="24"
            ...
            <div className="m-0 p-3 copyright-bar text-center">
                <p className="p-1 m-0 text-white">
                    Copyright Reamer Made © 2022 All Rights
                </p>
            </div>
        </footer>
    )
