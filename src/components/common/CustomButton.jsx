...
const CustomButton = ({
    ...
    const classes = `my-3 ${
        filled ? ' custom-btn' : 'custom-btn-outline'
    } ${customClasses}`
    return (
        <Link to={link} className={classes}>
            {showIcon && (
                ...
                >
                    <path
                        d="M19.081 1.22783L29.1614 11.0059L19.3833 21.0864L9.30291 11.3082L19.081 1.22783Z"
                        stroke="#FDF3EA"
                        strokeWidth="1.5"
                    />
            ...
            <span className={showIcon && 'with-spacing'}>{text}</span>
        </Link>
    )
}
