...
import CustomStaticButton from './CustomStaticButton'

const CustomNavbar = () => {
    return (
        <Navbar bg="dark" variant="dark" className="px-3 px-md-0 py-3">
            <Container className="my-1">
                ...
                <Nav className="mx-auto gap-4 d-none d-md-flex">
                    <NavLink to="/">Home</NavLink>
                    <NavLink to="/about-us">About Us</NavLink>
                    <NavLink to="/our-services">Our Services</NavLink>
                    <NavLink
                        to="/?scroll=featured-projects"
                        className={({ isActive }) =>
