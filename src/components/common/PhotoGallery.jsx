        ...
        <Row className="photo-row flex-wrap pt-4 pb-2 pb-md-4 px-0 mx-0">
            <Col xs={4} className="px-0">
                <div className="window" id="photo-1">
                    <img
                        src="https://www.dfwurbanrealty.com/uploads/bigstock-external-view-of-a-contemporar-61564541_650.jpg"
                        alt=""
                    />
                </div>
            ...
            <Col xs={4} className="px-0">
                <div className="window" id="photo-3">
                    <img
                        src="https://img.freepik.com/free-photo/house-isolated-field_1303-23773.jpg?w=2000"
                        alt=""
                    />
                </div>
            ...
            <Col xs={4} className="px-0">
                <div className="window" id="photo-5">
                    <img
                        src="https://img.freepik.com/premium-photo/3d-rendering-modern-house_62754-1884.jpg?w=2000"
                        alt=""
                    />
                </div>
