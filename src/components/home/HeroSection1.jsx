            ...
            <Container className="hero-section-home px-0 pb-4 pb-md-5 pb-md-0 ps-md-2">
                <Row className="m-0 p-0 px-4 px-md-0">
                    <Col
                        sm={12}
                        md={6}
                        className="hero-left px-4 px-md-0 d-flex my-auto pe-md-5"
                    >
                        <section className="pe-md-0 ps-md-1 hero-content align-self-center pt-4 pb-4">
                            <h1 className="px-0 text-white hero-title py-3 py-md-2">
                                We <span>Work Hard</span> to Make You Look Good.
                            </h1>
                            <h5 className="text-white hero-subtitle py-1 py-sm-2 py-md-4 fw-normal pe-0 pe-md-5 me-md-5">
                                A marketing firm that's truly made from the
                                ground up. We know the construction industry
                                inside and out, and we're here to help your
                                business grow.
                            </h5>
                    ...
                    <Col
                        sm={12}
                        md={6}
                        className="hero-right mb-1 mb-sm-2 mb-md-0 h-100 px-1 px-md-0 overflow-hidden"
                    >
